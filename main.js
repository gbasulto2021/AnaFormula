...
$inputsEscolaridad = d.querySelectorAll('#formulario input[name="escolaridad"]'),
...
var campos = {
  ...
  for(let i=0; i<$inputsUl.length; i++){
    $inputsUl[i].addEventListener("change", ()=>{
      ...
      d.querySelector(".ubicacion .formulario__input-error").classList.remove("formulario__input-error-activo");
  ...
  for(let i=0; i<$inputsCargaF.length; i++){
    $inputsCargaF[i].addEventListener("change", ()=>{
      ...
      d.querySelector(".resFamiliar .formulario__input-error").classList.remove("formulario__input-error-activo");
    })
  }
  for(let i=0; i<$inputsEscolaridad.length; i++){
    $inputsEscolaridad[i].addEventListener("change", ()=>{
      ...
      d.querySelector(".escolaridad .formulario__input-error").classList.remove("formulario__input-error-activo");
    })
  }
  for(let i=0; i<$inputsGarantia.length; i++){
    $inputsGarantia[i].addEventListener("change", ()=>{
      ...
      d.querySelector(".garantia .formulario__input-error").classList.remove("formulario__input-error-activo");
    })
  }
  ...
  $experiencia.addEventListener("keyup", ()=>{
    ...
    d.querySelector(".experiencia .formulario__input-error").classList.remove("formulario__input-error-activo");
  })
  ...
  $caPago.addEventListener("keyup", ()=>{
    ...
    d.querySelector(".capago .formulario__input-error").classList.remove("formulario__input-error-activo");
  })
  $otrosIng.addEventListener("keyup", ()=>{
    ...
    d.querySelector(".otrosingresos .formulario__input-error").classList.remove("formulario__input-error-activo");
  })
  $tasa.addEventListener("keyup", ()=>{
    ...
    d.querySelector(".tasa .formulario__input-error").classList.remove("formulario__input-error-activo");
  })
  ...
  const validarCampoRadio =()=>{
    ...
    if ($inputsUl[0].checked || $inputsUl[1].checked) {
      ...
      d.querySelector(".ubicacion .formulario__input-error").classList.add("formulario__input-error-activo");
    }
    if ($inputsCargaF[0].checked || $inputsCargaF[1].checked) {
      ...
      d.querySelector(".resFamiliar .formulario__input-error").classList.add("formulario__input-error-activo");
    }
    if ($inputsEscolaridad[0].checked || $inputsEscolaridad[1].checked) {
      ...
      d.querySelector(".escolaridad .formulario__input-error").classList.add("formulario__input-error-activo");
    }
    if ($inputsGarantia [0].checked || $inputsGarantia [1].checked) {
      ...
      d.querySelector(".garantia .formulario__input-error").classList.add("formulario__input-error-activo");
    }
  ...
  const validarCampoNumbers = ()=>{
    if ($experiencia.value !== "" && $experiencia.value !== null) {
      ...
      d.querySelector(".experiencia .formulario__input-error").classList.add("formulario__input-error-activo");
    }
    if ($caPago.value !== "" && $caPago.value !== null) {
      campos.caPago = true;
    }else{
      d.querySelector(".capago").classList.add("campo-incorrecto");
      d.querySelector(".capago .formulario__input-error").classList.add("formulario__input-error-activo");
    }
    if ($otrosIng.value !== "" && $otrosIng.value !== null) {
      ...
      d.querySelector(".otrosingresos .formulario__input-error").classList.add("formulario__input-error-activo");
    }
    if ($tasa.value !== "" && $tasa.value !== null) {
      campos.tasa = true;
    }else{
      d.querySelector(".tasa").classList.add("campo-incorrecto");
      d.querySelector(".tasa .formulario__input-error").classList.add("formulario__input-error-activo");
    }
  }
...
$formulario.addEventListener("submit", (e)=>{
    ...
    if (campos.ubicacion && campos.resFamiliar && campos.escolaridad && campos.garantia && campos.experiencia && campos.caPago && campos.otrosIngresos && campos.tasa) {
     let ubicacion,
         cargaF,
         escolaridad,
         garantia;
    ...
    d.querySelector(".resultado > p").innerHTML = total;
      ...
      d.querySelector(".resultado > p").innerHTML = "";
      return false;
    }
